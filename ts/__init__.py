...
_ts_types = {
    ...
    "EntryList_Integer_UUID": "Array<[number, (UUID | null)]>",
    "EntryList_Integer_Long": "Array<[number, Long]>",
    "EntryList_Integer_Integer": "Array<[number, number]>",
    "EntryList_UUID_Long": "Array<[(UUID | null), Long]>",
    "EntryList_String_EntryList_Integer_Long": "Array<[string, Array<[number, Long]>]>",
    "EntryList_UUID_UUID": "Array<[(UUID | null), (UUID | null)]>",
    "EntryList_UUID_List_Integer": "Array<[(UUID | null), number[]]>",
